                ...
                <Grid container className={classes.hero} >
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={12}>
                        <div style={{ width: "90%", margin: "50px auto 0 auto", textAlign: "center" }}>
                            <div >
                                <span className={classes.headerShadow}>Aquaria Tec </span> <span className={classes.subHeader}>Aquarium</span>
                            </div>
                            <div className={classes.heroDescription}>
                                <h3>Modern looking aquarium for you</h3>
                                <span className={classes.heroDescription}>Aquaria Tec is established in 2018 after discovering the great demand of modern looking fish tank.
                            ...
                            <div>
                                <Button variant='outlined' className={classes.button} onClick={() => this.handleConnectToday()}>Go to products</Button>
                            </div>
                        </div>
                    </Grid>
